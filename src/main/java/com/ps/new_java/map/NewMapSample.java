package com.ps.new_java.map;

import java.util.HashMap;
import java.util.Map;

public class NewMapSample {
	// As already mentioned maps don't support streams. Instead maps now support
	// various new and useful methods for doing common tasks.
	public static void main(String[] args) {
		...
		// The above code should be self-explaining: putIfAbsent prevents us from
		// writing additional if null checks; forEach accepts a consumer to perform
		// operations for each value of the map.
